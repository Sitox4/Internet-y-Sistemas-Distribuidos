...
public class ClientPartidoDto {
    ...
    public ClientPartidoDto(Long partidoId, String nombreVisitante, LocalDateTime celebracion, float precio, int maxEntradas) {
    ...
    public ClientPartidoDto(Long partidoId, String nombreVisitante, LocalDateTime celebracion, float precio, int maxEntradas, int vendidas) {
        this.partidoId = partidoId;
        this.nombreVisitante = nombreVisitante;
        this.celebracion = celebracion;
        this.precio = precio;
